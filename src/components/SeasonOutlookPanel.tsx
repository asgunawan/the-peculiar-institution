...
interface SeasonOutlookPanelProps {
  ...
  harvestOutlook: HarvestOutlook | null;
}
...
export default function SeasonOutlookPanel({
  ...
  const curingRiskClass =
    curingOutlook.shortfall === null ? "risk-low" : curingOutlook.shortfall > 0 ? "risk-high" : "risk-low";
  ...
  return (
    <section className="panel outlook-panel">
      ...
      <p className="outlook-meta">
        If you advance now: {nextSeason} {nextYear}
      </p>
