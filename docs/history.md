...
- Soil depletion rate: Wikipedia ("Tobacco in the American colonies") cites Craven (1926) — "Tobacco will wear out the soil in just a few years." Colonial History article confirms old fields were abandoned to pasture or woodlots. Scholarly consensus: 3–5 years of continuous planting to meaningful exhaustion, 5–7 years to full abandonment. A degrade of ~20 soil points per harvest (exhaustion in ~5 harvests) is the historically calibrated value. Values below 15 are too lenient; values above 25 are faster than primary sources support.
